...
# Attach the PDF file
file_path = "IIT Patna Invitation Brochure 2024-25.pdf"  # Replace with your PDF file path
file_name = "Invitation.pdf"  # Replace with desired file name in the email
